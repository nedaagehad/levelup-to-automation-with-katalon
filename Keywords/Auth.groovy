...
public class Auth {
	...
	def Login (String UserName, String Password) {
		...
		WebUI.setEncryptedText(findTestObject('Object Repository/CURA Healthcare Service/Login/input_Password_password'), CustomKeywords.'Auth.EncryptText'(Password))
